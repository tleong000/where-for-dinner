...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"where-for-dinner","dynamicDatabase":true,"serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1999709666715410095, --data-values-file, /tmp/accelerator-options12972102945620870936.json, --output-files, /tmp/ytt-output16320964589644690447]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"where-for-dinner","dynamicDatabase":true,"serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input17743778503613097930, --data-values-file, /tmp/accelerator-options17930498143386106715.json, --output-files, /tmp/ytt-output3558352954572965384]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dynamicMsgBroker":true,"dbType":"mysql","enableCloudEvents":false,"empty":"","enableSecurity":false,"gatewayType":"ossscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"dynamicDBClass":"mysql-unmanaged","secureProfile":"secure","artifactId":"where-for-dinner","dynamicDatabase":true,"serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"workloads","cacheType":"inmemCache","ployglotWorkloads":false}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input2390777750668305611, --data-values-file, /tmp/accelerator-options9220837890622718718.json, --output-files, /tmp/ytt-output16057481838765062657]
